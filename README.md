...
A single-file [FLAC](https://xiph.org/flac/) encoding library,
by [John Regan](https://github.com/jprjr). Does not
...
And then include `tflac.h` as follows:
```c
#include "node_modules/tflac.c/tflac.h"
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/tflac.c)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/jprjr/tflac)
